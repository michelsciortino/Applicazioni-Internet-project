...
public class ClientRace {
    ...
    public ClientRace(ClientLine line, DirectionType direction, Date date, RaceState raceState, List<ClientPassenger> passengers, List<ClientCompanion> companions, @Nullable ClientCompanion companion) {
        this.line = line;
